...
import type {
  ProductFeaturedListItem,
  ProductListItem,
} from './products.server'

import { resolveImageUrl } from '@/common/lib'

type Product = ProductListItem | ProductFeaturedListItem

export const mapProductToDto = (product: Product, locale: LocaleKey) => {
  const translation =
...
export type ProductDto = ReturnType<typeof mapProductToDto>
